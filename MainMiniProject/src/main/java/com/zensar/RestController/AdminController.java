...
@GetMapping(value = "/getAllbooking/{customerId}")
...
public List<TripBooking>f7(@PathVariable(name="customerid")int customerid,@PathVariable(name = "fromDate")LocalDateTime from,@PathVariable(name = "toDate")LocalDateTime to){
